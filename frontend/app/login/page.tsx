  ...
  return (
    <div className="auth-root" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <style jsx global>{`
        ...
        .auth-stats { display:flex; gap:2rem; padding-top:2rem; border-top:1px solid rgba(255,255,255,0.07); }
        .auth-stat-val { font-size:1.6rem; font-weight:900; color:#fff; line-height:1; }
        .auth-stat-lbl { font-size:.75rem; color:#8696a0; margin-top:.2rem; }
        ...
        .auth-forgot { font-size:.78rem; color:#00a884; text-decoration:none; font-weight:600; }
